...
def prediction(row):
  ...
  with open('scaler.pkl', 'rb') as pkl_file: # уточнить адрес файла
    scaler = pickle.load(pkl_file)

  with open('model_lr.pkl', 'rb') as pkl_file: # уточнить адрес файла
    model_lr = pickle.load(pkl_file)
  
  with open('model_rf.pkl', 'rb') as pkl_file: # уточнить адрес файла
  ...
  with open('model_dt.pkl', 'rb') as pkl_file: # уточнить адрес файла
